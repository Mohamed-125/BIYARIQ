      ...
      >
        {filteredWarehouses.length > 0 ? (
          filteredWarehouses.map((warehouse) => (
            <Link
              href={`/seller/[id]/dashboard/manage-digital-products/digital-warehouses/${warehouse.id}`}
              as={`/seller/1/dashboard/manage-digital-products/digital-warehouses/${warehouse.id}`}
              key={warehouse.id}
            >
