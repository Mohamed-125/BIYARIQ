...
export default function AddCoursePage() {
  ...
  const addLesson = (
    ...
    const newLesson: Lesson = {
      ...
      content: "",
      isPreview: false,
      videoUrl: type === "فيديو" ? "" : undefined,
      documentUrl: type === "مستند" ? "" : undefined,
      questions: type === "اختبار" ? [] : undefined,
    };
    setUnits(
      units.map((unit) => {
        if (unit.id === unitId) {
                            ...
                            >
                              ...
                              <div className="mt-4 flex items-center justify-between">
                                ...
                                <button
                                  type="button"
                                  onClick={() =>
                                    removeLesson(unit.id, lesson.id)
                                  }
                                  className="p-2 text-red-500 hover:bg-red-50 rounded-full transition-colors"
                                >
                                  <X size={20} />
