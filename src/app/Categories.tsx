        ...
        >
          {categories.map((category, index) => {
            ...
            return (
              <motion.div
                key={index}
                className={`group relative cursor-pointer overflow-hidden rounded-[2rem] bg-white shadow-lg hover:shadow-2xl transition-all duration-500 ease-out 
          ${
            isLastSingle
              ? "md:col-span-3"
              : index === 0 || index === 3
